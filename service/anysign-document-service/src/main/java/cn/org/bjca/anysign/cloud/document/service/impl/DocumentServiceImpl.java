...
public class DocumentServiceImpl implements IDocumentFormatService {
   ...
   * @return 有效图片列表
   */
  private List<byte[]> getValidImgs(List<byte[]> imgList, final int startPageNum,
   ...
   */
  private List<byte[]> convert2ImgList(byte[] pdfBty, int start, int end, boolean judgeScope)
      throws Exception {
    PDFConvertTool pdfConvertTool = new PDFConvertTool();
