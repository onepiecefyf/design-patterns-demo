...
public class ImageHandleUtil {
   ...
   */
  public static void writeBufferedImage2File(BufferedImage bufferedImage, String format,
   ...
   */
  public static BufferedImage resize(byte[] srcImg, int scaledWidth, int scaledHeight)
      throws IOException {
    // 读取源图片
   ...
   */
  public static BufferedImage scaleByProportion(BufferedImage srcImageFile, int scale,
      boolean scaleSelection) {
   ...
   */
  public static BufferedImage scaleByWidthAndHeight(BufferedImage srcImageFile, int height,
      int width, boolean fillWhite) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    ImageHandleUtil.scaleByWidthAndHeight(inputImg, (int) (inputImg.getHeight() * ratio),
        (int) (inputImg.getWidth() * ratio), true);
