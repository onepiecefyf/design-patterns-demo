...
public class VerifySignRequestBean extends CommonRequestParam {
  ...
  public static VerifySignRequestBean build(String appId, String deviceId, String signAlgo,
      String version, String data, String dataType, String base64Cert, String signAlgIdentifier,
      String signResultType, String transId, String signValue, String verifyCertPolicyId) {
