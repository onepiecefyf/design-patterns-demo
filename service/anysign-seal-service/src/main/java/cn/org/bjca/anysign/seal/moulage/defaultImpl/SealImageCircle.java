...
public class SealImageCircle extends SealImage {
  ...
  public static byte[] creatCircle(SealImageBean sealImageBean) {
    ...
    Map<String, Object> shapeDec = buildShape(sealImageBean.getShape().ordinal(),
        sealImageBean.getBorderColor(), sealImageBean.getBorderWeight(), o[0], o[1], r, 0);
    try {
      if (sealImageBean.isStar()) {
        ei.createSeal(bao, width, height, sealImageBean.getTxtDescs(), shapeDec, o[0] - 14,
            o[1] - 14);
      } else {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Map<String, Object> topTxt = buildText("北京数字认证股份有限公司", "#ff0000", 12, "公章刻章字体", "bold",
        "M29,88 A41,41 0 1,1,90,88");
...
//        Map<String, Object> centerTxt1 = buildText("12346789", "#ff0000", 22, "公章刻章字体", "bold", "M20,170 L277,170");
    Map<String, Object> centerTxt2 = buildText("发票专用章", "#ff0000", 12, "公章刻章字体", "bold",
        "M21,92 L100,92");
    txtDescs.add(topTxt);
