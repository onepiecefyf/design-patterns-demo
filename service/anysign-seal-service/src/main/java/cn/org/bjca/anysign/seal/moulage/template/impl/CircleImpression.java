...
public class CircleImpression {
     ...
     * @return
     */
    public static byte[] createCircleImpression(String head, String foot, String value, boolean start) {
        return createCircleImpression(head, foot, value, R, R, THICK, R / 10, R / 10, 50, FONTFIM, FONTFIM, FONTFIM
    ...
    public static byte[] createCircleImpression(String[] strings) {
        return createCircleImpression(strings[0], strings[1], strings[2], R, R, THICK, R / 10, R / 10, 50, FONTFIM, FONTFIM, FONTFIM
    ...
    public static byte[] createCircleImpression(String head, String foot, String value,
        ...
        g2.setFont(f);
        g2.drawString(foot, (float) (circleRadius - bounds.getCenterX() + thick), (float) (circleRadius * 1.6 - bounds.getCenterY()));
        /***************center**************/
        if (stars) {
            ...
            g2.drawString("★", canvasWidth / 2 - textWidth / 2, (canvasHeight - textHeight) / 2 + textHeight - THICK);
        }
        /***************head**************/
        ...
        if (countOfMsg % 2 == 1) {
            ...
            firstAngle = (countOfMsg / 2.0 - 1) * radianPerInterval + radianPerInterval / 2.0 + Math.PI / 2 + 0.1;
        }
        ...
        if (countOfValue % 2 == 1) {
            ...
            firstAngleValue = -(countOfValue / 2.0 - 1) * radianValueInterval + radianValueInterval / 2.0 + Math.PI * 1.5 - 0.11;
        }
