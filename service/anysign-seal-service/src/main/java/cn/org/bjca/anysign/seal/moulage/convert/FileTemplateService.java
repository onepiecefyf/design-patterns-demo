...
public class FileTemplateService implements ITemplateService {
     ...
     * 文件模板路径
     */
    private static final String FILEPATH = SystemConstants.HOMEPATH.concat("/BJCAROOT/template/templateImpression.dat");
    /**
     * 模板备份
     */
    private static final String FILEPATHBAK = SystemConstants.HOMEPATH.concat("/BJCAROOT/template/templateImpression_bak.dat");
            ...
            if (null != map) {
                list.forEach(rider -> {
                    ...
                    if (StringUtils.isNotEmpty(value)) {
                        ...
                        log.warn("Template id is {}, but rider Order {} value is null", template.getTempId(), rider.getOrder());
                    }
                });
            } else {
