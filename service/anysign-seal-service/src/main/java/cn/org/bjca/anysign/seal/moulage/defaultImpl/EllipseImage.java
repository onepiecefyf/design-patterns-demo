...
public class EllipseImage implements ISealImage {
     ...
     * 椭圆
     */
	private static String templateEllipse = "<svg contentScriptType=\"text/ecmascript\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns=\"http://www.w3.org/2000/svg\"\n"
	...
	private String genHead(String htext) {
		...
		return "<defs><path id=\"pathhead\" d=\"M110,212 A128,88 0 1,1,288,212\"/></defs><text style=\"fill:red;\" font-size=\"25\" font-family=\"公章刻章字体\" font-weight=\"bold\"><textPath xlink:href=\"#pathhead\" text-anchor=\"middle\"  startOffset=\"50%\"  lengthAdjust=\"spacing\">"
				+ htext + "</textPath></text>";
	}
	...
	private String genCenter(String text, int offset){
		...
		return "<defs><path id=\"center\" d=\"M102,160 L300,160\"/></defs><text style=\"fill:red;\">\r\n" + 
				"<textPath xlink:href=\"#center\" lengthAdjust=\"spacing\" style=\"font-family: 公章刻章字体;font-size:22;font-weight:bold;\" >"+text+"</textPath></text>";
	}
	...
	private String genTextFoot1(String text, int offset){
		...
		return "<defs><path id=\"pathfoot1\" d=\"M137,208 L300,208\"/></defs>\r\n" + 
				"<text style=\"fill:red;\">\r\n" + 
				"<textPath xlink:href=\"#pathfoot1\" lengthAdjust=\"spacing\" style=\"font-family: 公章刻章字体;font-size:30;font-weight:bold;\">"+text+"</textPath></text>";
	}
	...
	@Override
	public void createSeal(OutputStream outputStream, List<String> imageTexts, String centerFlag, Float width,
