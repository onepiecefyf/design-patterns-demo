...
public class RectangleImpression {
    ...
    public static byte[] createRectangle(String head, int canvasWidth, int canvasHeight, float thick,
        ...
        //设置透明背景
        bi = g2.getDeviceConfiguration().createCompatibleImage(canvasWidth, canvasHeight, Transparency.TRANSLUCENT);
        ...
        if (StringUtils.isEmpty(rgb)) {
            ...
            for (int i = 0; i < strings.length; i++) {
                ...
                if (StringUtils.isEmpty(number)) {
                    throw new BaseRuntimeException(StatusConstants.PARAMETER_ERROR.getStatus(), "印模颜色参数设置错误！");
                }
