...
public class SignImageServiceImpl implements ISignImageService {
    ...
    private String createFile(byte[] bytes, CommonRequestParam commonRequestParam) {
        ...
        UploadRequestBean uploadRequestBean = UploadRequestBean.build(httpConfig.appId, commonRequestParam.getAppId(),
                httpConfig.deviceId, httpConfig.version, null, null, Integer.MAX_VALUE, httpConfig.secret, fileName.concat(".png"),
                bytes);
