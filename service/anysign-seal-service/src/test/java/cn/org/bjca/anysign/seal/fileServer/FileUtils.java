...
//        param.put("id", "ffa5697b42024f798296ab475af3c080");
        ...
        System.out.println(Base64Utils.byte2Base64StringFun(HMacUtils.sha256_HMAC(sortedMapUtils.toString(), "Tqn1zejjneKdpqccW2dVW8fpWjRt40CN")));
//        param.put("signature", Base64Utils.byte2Base64StringFun(HMacUtils.sha256_HMAC(sortedMapUtils.toString(), "Tqn1zejjneKdpqccW2dVW8fpWjRt40CN")));//whj
        param.put("signature", Base64Utils.byte2Base64StringFun(HMacUtils.sha256_HMAC(sortedMapUtils.toString(), "vbXaD7PQnz1H4zHqG5GFIFBgf23SnXv4")));//whp
    ...
    public void download() {
        ...
        DownloadRequestBean downloadRequestBean = DownloadRequestBean.build("APP_5439463B5AA7450EA8D784E4AF70D33C",
        ...
        param2.put("signature", Base64Utils.byte2Base64StringFun(HMacUtils.sha256_HMAC(sortedMapUtils.toString(),
    ...
    public void access() {
        ...
        SortedMapUtils sortedMapUtils = new SortedMapUtils(param);
        param.put("signature", Base64Utils.byte2Base64StringFun(HMacUtils.sha256_HMAC(sortedMapUtils.toString(), "vbXaD7PQnz1H4zHqG5GFIFBgf23SnXv4")));
