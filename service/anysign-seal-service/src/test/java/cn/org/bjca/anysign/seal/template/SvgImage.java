...
public class SvgImage {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Map<String, Object> topTxt = buildText("北京市规划和国土资源管理委员会", "#ff0000", 16, "公章刻章字体", "bold",
        "M1,28 194,28");
//        Map<String, Object> topTxt = buildText(name, "#ff0000", 25, "公章刻章字体", "bold", path);
    Map<String, Object> centerTxt1 = buildText("规划国土审批文件附图专用章", "#ff0000", 18, "公章刻章字体", "bold",
        "M7,56 189,56");
    Map<String, Object> centerTxt2 = buildText("（XX）规土XX字xx号", "#ff0000", 17, "公章刻章字体", "bold",
        "M5.0,82 189,82");
    txtDescs.add(topTxt);
