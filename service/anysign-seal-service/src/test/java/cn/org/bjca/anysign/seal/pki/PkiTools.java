...
public class PkiTools {
  ...
  public void getCert() throws Exception {
    ...
    String sign = new DEROctetString(Base64Utils.base64String2ByteFun(
        "MEUCIQCLbfH6+fwKSzJ3zxBrpns23P43YOSntyqai4rZ3VTvqwIgEd4pQL4w7IaX1C4Va3ijpk5quXXOBc7rED2d8SWuRLE="))
        .toString();
