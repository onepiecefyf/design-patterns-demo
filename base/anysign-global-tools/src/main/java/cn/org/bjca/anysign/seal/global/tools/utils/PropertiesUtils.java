...
public class PropertiesUtils {
    ...
    public int getInt(String key, int defvalue) {
        return (StringUtils.isEmpty(properties.getProperty(key))) ? defvalue : Integer.valueOf(properties.getProperty(key));
    }
    ...
    public String getString(String key, String defvalue) {
        return (StringUtils.isEmpty(properties.getProperty(key))) ? defvalue : properties.getProperty(key);
    }
    ...
    public boolean getBoolean(String key, boolean defvalue) {
        return (StringUtils.isEmpty(properties.getProperty(key))) ? defvalue : Boolean.valueOf(properties.getProperty(key));
    }
