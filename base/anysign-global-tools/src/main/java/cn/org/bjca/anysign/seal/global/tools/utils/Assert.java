...
public class Assert {
     ...
     */
    public static void state(boolean expression, String message, String serverName, String methodName) {
        if (!expression) {
     ...
     * @param methodName      调用方法
     */
    public static void state(boolean expression, StatusConstants statusConstants, String message, String serverName, String methodName) {
        if (!expression) {
     ...
     * @param methodName      方法名称
     */
    public static void notNull(Object object, StatusConstants statusConstants, String serverName, String methodName) {
        if (object == null) {
            throw new BaseRuntimeException(statusConstants, serverName, methodName);
        }
    }

    public static void notEntity(String object, StatusConstants statusConstants, String serverName, String methodName) {
        if (null == object || object.equals("")) {
            throw new BaseRuntimeException(statusConstants, serverName, methodName);
        }
    }

    public static void notNullBytes(byte[] object, StatusConstants statusConstants, String serverName, String methodName) {
     ...
     * @param methodName      方法名称
     */
    public static void notNull(Object object, StatusConstants statusConstants, String message, String serverName, String methodName) {
        if (object == null) {
            throw new BaseRuntimeException(statusConstants, message, serverName, methodName);
        }
    }
