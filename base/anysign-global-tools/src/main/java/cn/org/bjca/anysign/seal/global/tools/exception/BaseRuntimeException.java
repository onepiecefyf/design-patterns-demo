...
public class BaseRuntimeException extends RuntimeException {
   ...
   */
  public BaseRuntimeException(StatusConstants statusConstants, String serverName,
      String methodName) {
    super(statusConstants.getMessage());
    this.status = statusConstants.getStatus();
  ...
  public BaseRuntimeException(StatusConstants statusConstants, String message) {
    ...
    this.status = statusConstants.getStatus();
    this.msg = this.status.concat(":")
        .concat(String.format(MESSAGE, statusConstants.getMessage(), message));
  }
   ...
   * @param methodName 方法名称
   */
  public BaseRuntimeException(StatusConstants statusConstants, String message, String serverName,
      String methodName) {
    super(String.format(MESSAGE, statusConstants.getMessage(), message));
    this.status = statusConstants.getStatus();
    this.serverName = serverName;
