...
public class GlobalDefultExceptionHandler {
  ...
  public BaseResponse baseExceptionHandler(BaseRuntimeException e) {
    log.error("BaseRuntimeException information is captured : status is {} , message is {}",
  ...
  @ResponseBody
  public BaseResponse baseHttpMessageNotReadableExceptionHandler(
      HttpMessageNotReadableException e) {
    return new BaseResponse(StatusConstants.PARAMETER_ERROR.getStatus(),
        StatusConstants.PARAMETER_ERROR.getMessage(),
        e.getClass().getName().concat(" : ").concat(e.getMessage()));
  }
  ...
  public BaseResponse defaultExceptionHandler(Exception e) throws IOException {
    ...
    return new BaseResponse(StatusConstants.FAIL,
        e.getClass().getName().concat(" : ").concat(e.getMessage()));
  }
