...
public class RSAVerify {
  ...
  public void rsaVerify() throws Exception {
    ...
    byte[] bytes = {66, -84, -121, -63, 119, -100, 55, 61, -35, -74, -86, 88, -70, -92, -69, 28, 6,
        71, -13, 39, -46, -122, 43, 4, 120, -13, -39, 19, -73, 111, -75, -16, -13, 62, -90, -75,
        -126, 126, 122, 98, 39, 102, -46, 25, -14, -115, 73, -22, 58, 36, 111, -6, -47, -128, -113,
        -9, 43, -112, 45, -83, -3, 4, -51, -24, 93, -59, -85, 94, 2, -56, -5, -66, -123, -112, -103,
        -108, 43, 74, -54, 99, 119, -74, 23, -46, -90, 86, 127, -49, 76, 7, -27, -124, -45, 49, 61,
        -108, -5, 99, 91, -104, -49, 25, 102, -36, 79, -50, 126, 54, 4, -114, 47, 12, 75, -86, 119,
        -128, 118, 28, -114, -74, -21, -127, 0, 75, -80, 106, 36, 29};
    ...
    byte[] hashme = Base64Utils
        .base64String2ByteFun("1fny0vmRtvaAlzo+qr+FzCbs2nXVgUwWKDhrEhlmOfI=");
...
//                new File("E:\\test\\CertExchangewhjw.cer")));
    X509Certificate signCert = ItextUtil.readBytesToX509Certificate(Base64Utils
        .base64String2ByteFun(
    ...
    sig.update(Base64Utils.base64String2ByteFun(
        "MWkwGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTgxMjEzMDY1MDM0WjAvBgkqhkiG9w0BCQQxIgQguUg37c58ipfJaTcgJ0lgdfodATneVKdT2QsgPFo44zI="));
    boolean boo = sig.verify(Base64Utils.base64String2ByteFun(
        "g5uEBNAEcIZamQmhs1mxXyTV2uLE+y90+XRhaKIyyEev/usweVUTOq05hUMmYxHx5ChiCvwohGKXM+EzPAmfrVci+qwyVuLFZJHwYTfw4dDB+wihvtvtd065skLjPhnw+IZMLxZ/B6hRuG6A60nIpxpOtLchLkNoXdGBrcZVX6Y="));
