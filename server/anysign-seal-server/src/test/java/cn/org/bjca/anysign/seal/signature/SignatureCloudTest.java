...
public class SignatureCloudTest {
    ...
    public void signatureRSA() {
        ...
        JSONObject object = HttpUtils.doPost(url, JSON.parseObject(JSON.toJSONString(buildSignatureRequest("RSA"))));
        System.out.println(object.toString());
        System.out.println(object.getString("status"));
    }
    ...
    public static DepositCertApplyRequestBean buildDepositCertApplyRequestBean() {
        DepositCertApplyRequestBean depositCertApplyRequestBean =
                DepositCertApplyRequestBean.build("APP_5439463B5AA7450EA8D784E4AF70D33C", "DEV_E745E51F740E4472AB55D00F3A77163C",
                        "HMAC", "1.0", "RSA", "2048", "", null, null
                        , "张三", "USER_IDCARD", "13256423542651", "1223254226", null, "BJCA_RSA_SHA1", "TRANS_1234567910");
