...
//        String url = "https://api.isignet.cn/seal/v1/pdfSignature";
        JSONObject object = HttpUtils.doPost(url, JSON.parseObject(JSON.toJSONString(buildSignatureRequest(alg))));
        System.out.println(object.toString());
        System.out.println(object.getString("status"));
    }
...
//        String url = "http://beta.isignet.cn:28081/seal/v1/sealVerify";
        JSONObject object = HttpUtils.doPost(url, JSON.parseObject(JSON.toJSONString(buildSignatureVerifyRequest(alg))));
        System.out.println(object.getString("status"));
    }
...
//        String url = "https://api.isignet.cn/seal/v1/pdfDigest";
        ...
        JSONObject object = HttpUtils.doPost(url, JSON.parseObject(JSON.toJSONString(buildDigestRequestRequest(alg))));
        System.out.println(object.getString("status"));
    }
...
//        String url = "http://127.0.0.1:10501/seal/v1/pdfMerging";
        ...
        JSONObject object = HttpUtils.doPost(url, JSON.parseObject(JSON.toJSONString(mergingRequest())));
        System.out.println(object.getString("status"));
    }
    ...
    public static MergingRequest mergingRequest() {
        ...
        mergingRequest.setSignData("QqyHwXecNz3dtqpYuqS7HAZH8yfShisEePPZE7dvtfDzPqa1gn56Yidm0hnyjUnqOiRv+tGAj/crkC2t/QTN6F3Fq14CyPu+hZCZlCtKymN3thfSplZ/z0wH5YTTMT2U+2NbmM8ZZtxPzn42BI4vDEuqd4B2HI6264EAS7BqJB0=");
        byte[] buffer = null;
        InputStream is = null;
        try {
...
//        kwRule.setLExcursion(-200);
    ...
    public void Base64ToByte() {
        byte[] bytes = Base64Utils.base64String2ByteFun("QqyHwXecNz3dtqpYuqS7HAZH8yfShisEePPZE7dvtfDzPqa1gn56Yidm0hnyjUnqOiRv+tGAj/crkC2t/QTN6F3Fq14CyPu+hZCZlCtKymN3thfSplZ/z0wH5YTTMT2U+2NbmM8ZZtxPzn42BI4vDEuqd4B2HI6264EAS7BqJB0=");
        StringBuffer sb = new StringBuffer();
        for (byte b : bytes) {
            sb.append(b);
            sb.append(",");
    ...
    public void arrayToBytes() {
        byte[] bytes = {-47, -123, -79, 39, -67, -123, -124, -116, 120, -51, 124, 93, -118, 79, -123, -3, 18, 5, -42, -37, -81, 13, 25, -79, 75, -35, -11, 71, -108, 14, -91, -42, -90, 109, -99, -43, 49, -65, -64, -93, -18, 104, 88, 9, 10, -65, -24, 53, 110, 23, -82, -46, -27, -100, 25, 72, -67, -1, 117, 101, -111, 14, -30, 84, 7, 47, 6, -73, 19, 106, 9, 4, 27, -7, -2, -99, -105, 53, -121, 103, 73, -109, -105, -35, -117, 103, -122, 59, -127, 61, 121, 112, 40, -88, -50, -107, -26, 92, -120, 39, 0, 62, 96, 49, 125, 58, -20, -13, -35, -91, -55, 88, -10, 113, -6, 45, -11, -89, -64, -98, -123, -48, 123, 90, 31, -2, 55, -3};
