...
public abstract class BaseController {
    ...
    void checkTemplateReqParams(TemplateReqMessage templateReqMessage) {
        ...
        Assert.state(judgeTransmissionFileType(templateReqMessage.getFileTransmissionType()),
                ...
                String.format("The fileTransmissionType %s is wrong.",  templateReqMessage.getFileTransmissionType()),
                "模板服务", "填充模板");
        // 请求报文内容类型只能为JSON 或 XML
        Assert.state(judgeDataStringType(templateReqMessage.getDataType()), StatusConstants.TEMPLATE_PARAMETER_ERROR,
